...
import com.ptracker.entities.LocationModel;
...
public class LocationTrackerActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, GoogleMap.OnMapClickListener, GoogleMap.OnMapLongClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference radiusDatabaseReference = mFirebaseInstance.getReference("radius");
        System.out.println("radi refer "+radiusDatabaseReference);
        mFirebaseDatabase = mFirebaseInstance.getReference("users");



        radiusDatabaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                Log.e("teststt onDataChange", "======="+dataSnapshot.getValue() );
            ...
            public void onCancelled(DatabaseError error) {
                ...
                Log.e("testtt", "Failed to read app title value.", error.toException());
            }
        });


        DatabaseReference databaseReference = mFirebaseDatabase.child("users");
    ...
    private void loadCoordinates(LatLng location) {
        ...
        if (location != null) {
            drawCircle(location);
            drawMarker(location, "Hospital Campus");
    ...
    private void saveToDB(LatLng location) {
...
//        String userId = mFirebaseDatabase.push().getKey();
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (mLastLocation != null) {
            ...
            saveToDB(currentLocation);

        }

//
//        // Checks, whether start and end locations are captured
//        if (currentLocation != null && hospitalLocation != null) {
//
//            // Getting URL to the Google Directions API
//            String url = getUrl(currentLocation, hospitalLocation);
